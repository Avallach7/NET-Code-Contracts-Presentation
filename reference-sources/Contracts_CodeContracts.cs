// Source: https://github.com/Microsoft/CodeContracts/blob/master/Foxtrot/Contracts/Contracts.cs
...
namespace System.Diagnostics.Contracts
{
    ...
    /// <summary>
    /// Provides options to downstream tools on how to deal with particular parts of an assembly. For example, whether to 
    /// perform runtime contract instrumentation, static verification, etc. Accepted options are documentated by particular
    /// contract tools.
    /// </summary>
    /// <remarks>
...
/// </summary>
        ...
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
#endif
        //@BUGBUG: The FxCop team would prefer WritableBytes to return a boolean instead of a size.
        //@BUGBUG: MAF: I don't think that would be a good idea.
